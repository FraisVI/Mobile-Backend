...
@section('content')
    ...
    <form id="stories-form" class="form-floating needs-validation" action="{{ route('stories.store') }}" method="post" enctype="multipart/form-data" novalidate>
        @csrf
        ...
        <div class="row mb-4">
            ...
            <div class="row">
                <div class="col-lg-6 mb-3">
                    <input type="file" class="form-control" name="thumb" accept="image/jpeg, image/png, image/gif" required>
                </div>
            </div>
        </div>
